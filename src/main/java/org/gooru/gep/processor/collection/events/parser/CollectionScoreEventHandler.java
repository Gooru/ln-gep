 ...
 *  
 */
public class CollectionScoreEventHandler {
	
    private static final Logger LOGGER = LoggerFactory.getLogger(CollectionScoreEventHandler.class);

	   private CollectionScoreEventHandler() {
	        throw new AssertionError();
	    }
	    
	    public static MessageResponse collectionScoreEventCreate(CollectionEventCreator eventCreator) {     
	    	ExecutionResult<MessageResponse> executionResult = createCollectionScoreEvent(eventCreator);
	    	return executionResult.result();
	    }
	    
	    
	    private static ExecutionResult<MessageResponse> createCollectionScoreEvent(CollectionEventCreator eventCreator) {
