...
public class AppRunner {
    ...
    private void initializeApplication() {
	  ...
	  private void createConsumer(JSONObject config) {
		    ...
		    LOGGER.debug("kafka config props" + kafkaConfig.getString(Constants.Config.CONFIG_KAFKA_SERVERS));
		    props.put(Constants.Config.CONFIG_KAFKA_SERVERS, kafkaConfig.getString(Constants.Config.CONFIG_KAFKA_SERVERS));
		    props.put(Constants.Config.CONFIG_KAFKA_TIME_OUT_IN_MS, kafkaConfig.getString(Constants.Config.CONFIG_KAFKA_TIME_OUT_IN_MS));
		    props.put(Constants.Config.CONFIG_KAFKA_GROUP, kafkaConfig.getString(Constants.Config.CONFIG_KAFKA_GROUP));
		    ...
		    String[] topics = kafkaConfig.getString(Constants.Config.CONFIG_KAFKA_TOPICS).split(Constants.Config.COMMA);
